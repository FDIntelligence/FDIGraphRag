...
from fdigraphrag.config.enums import (
    AsyncType,
    AuthType,
    CacheType,
    ChunkStrategyType,
...
class ExtractGraphDefaults:
    ...
    entity_types: list[str] = field(
        default_factory=lambda: ["COMPANY","SECTOR" ]
    )
    max_gleanings: int = 1
    strategy: None = None
    encoding_model: None = None
...
@dataclass
class fdigraphragConfigDefaults:
    """Default values for fdigraphrag."""
...
fdigraphrag_config_defaults = fdigraphragConfigDefaults()
