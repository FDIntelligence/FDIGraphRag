...
def get_embedded_fields(settings: fdigraphragConfig) -> set[str]:
...
def get_embedding_settings(
    settings: fdigraphragConfig,
    vector_store_params: dict | None = None,
) -> dict:
    """Transform fdigraphrag config into settings for workflows."""
    # TEMP
...
def create_collection_name(
    ...
    The embedding name is fixed, with the available list defined in fdigraphrag.index.config.embeddings
