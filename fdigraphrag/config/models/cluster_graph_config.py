...
class ClusterGraphConfig(BaseModel):
    ...
    max_cluster_size: int = Field(
        ...
        default=fdigraphrag_config_defaults.cluster_graph.max_cluster_size,
    )
    use_lcc: bool = Field(
        description="Whether to use the largest connected component.",
        default=fdigraphrag_config_defaults.cluster_graph.use_lcc,
    )
    seed: int = Field(
        description="The seed to use for the clustering.",
        default=fdigraphrag_config_defaults.cluster_graph.seed,
    )
