...
class SummarizeDescriptionsConfig(BaseModel):
    ...
    prompt: str | None = Field(
        ...
        default=fdigraphrag_config_defaults.summarize_descriptions.prompt,
    )
    max_length: int = Field(
        description="The description summarization maximum length.",
        default=fdigraphrag_config_defaults.summarize_descriptions.max_length,
    )
    strategy: dict | None = Field(
        description="The override strategy to use.",
        default=fdigraphrag_config_defaults.summarize_descriptions.strategy,
    )
    model_id: str = Field(
        description="The model ID to use for summarization.",
        default=fdigraphrag_config_defaults.summarize_descriptions.model_id,
    )
    ...
    def resolved_strategy(
        ...
        from fdigraphrag.index.operations.summarize_descriptions import (
