...
This API provides access to the auto templating feature of fdigraphrag, allowing external applications
to hook into fdigraphrag and generate prompts from private data.
...
from fdigraphrag.config.defaults import fdigraphrag_config_defaults, language_model_defaults
from fdigraphrag.config.models.graph_rag_config import fdigraphragConfig
from fdigraphrag.language_model.manager import ModelManager
from fdigraphrag.logger.base import ProgressLogger
from fdigraphrag.prompt_tune.defaults import MAX_TOKEN_COUNT, PROMPT_TUNING_MODEL_ID
from fdigraphrag.prompt_tune.generator.community_report_rating import (
    generate_community_report_rating,
)
from fdigraphrag.prompt_tune.generator.community_report_summarization import (
    create_community_summarization_prompt,
)
from fdigraphrag.prompt_tune.generator.community_reporter_role import (
    generate_community_reporter_role,
)
from fdigraphrag.prompt_tune.generator.domain import generate_domain
from fdigraphrag.prompt_tune.generator.entity_relationship import (
    generate_entity_relationship_examples,
)
from fdigraphrag.prompt_tune.generator.entity_summarization_prompt import (
    create_entity_summarization_prompt,
)
from fdigraphrag.prompt_tune.generator.entity_types import generate_entity_types
from fdigraphrag.prompt_tune.generator.extract_graph_prompt import (
    create_extract_graph_prompt,
)
from fdigraphrag.prompt_tune.generator.language import detect_language
from fdigraphrag.prompt_tune.generator.persona import generate_persona
from fdigraphrag.prompt_tune.loader.input import load_docs_in_chunks
from fdigraphrag.prompt_tune.types import DocSelectionType
...
async def generate_indexing_prompts(
    ...
    root: str,
    chunk_size: PositiveInt = fdigraphrag_config_defaults.chunks.size,
    overlap: Annotated[
        int, annotated_types.Gt(-1)
    ] = fdigraphrag_config_defaults.chunks.overlap,
    ...
    Parameters
    ----------
    - config: The fdigraphrag configuration.
