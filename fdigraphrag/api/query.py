...
This API provides access to the query engine of fdigraphrag, allowing external applications
to hook into fdigraphrag and run queries over a knowledge graph generated by fdigraphrag.
...
from fdigraphrag.query.factory import (
    get_basic_search_engine,
    get_drift_search_engine,
    get_global_search_engine,
    get_local_search_engine,
)
from fdigraphrag.query.indexer_adapters import (
...
from fdigraphrag.utils.api import (
    get_embedding_store,
    load_search_prompt,
    update_context_data,
)
...
async def global_search(
    ...
    Parameters
    ----------
    - config (fdigraphragConfig): A fdigraphrag configuration (from settings.yaml)
