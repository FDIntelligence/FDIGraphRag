...
from fdigraphrag.config.defaults import ENCODING_MODEL, fdigraphrag_config_defaults
from fdigraphrag.index.typing.error_handler import ErrorHandlerFn
from fdigraphrag.index.utils.string import clean_str
from fdigraphrag.language_model.protocol.base import ChatModel
from fdigraphrag.prompts.index.extract_graph import (
    CONTINUE_PROMPT,
...
class GraphExtractor:
    ...
    def __init__(
        ...
        self._max_gleanings = (
            ...
            else fdigraphrag_config_defaults.extract_graph.max_gleanings
        )
