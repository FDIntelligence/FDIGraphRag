...
from fdigraphrag.config.enums import AsyncType
from fdigraphrag.index.operations.extract_graph.typing import (
    Document,
    EntityExtractStrategy,
    ExtractEntityStrategyType,
)
from fdigraphrag.index.utils.derive_from_rows import derive_from_rows
...
def _load_strategy(strategy_type: ExtractEntityStrategyType) -> EntityExtractStrategy:
    ...
    match strategy_type:
        case ExtractEntityStrategyType.graph_intelligence:
            from fdigraphrag.index.operations.extract_graph.graph_intelligence_strategy import (
