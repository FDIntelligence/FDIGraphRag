...
from fdigraphrag.config.embeddings import create_collection_name
from fdigraphrag.index.operations.embed_text.strategies.typing import TextEmbeddingStrategy
from fdigraphrag.vector_stores.base import BaseVectorStore, VectorStoreDocument
from fdigraphrag.vector_stores.factory import VectorStoreFactory
...
def load_strategy(strategy: TextEmbedStrategyType) -> TextEmbeddingStrategy:
    ...
    match strategy:
        case TextEmbedStrategyType.openai:
            from fdigraphrag.index.operations.embed_text.strategies.openai import (
                run as run_openai,
            )

            return run_openai
        case TextEmbedStrategyType.mock:
            from fdigraphrag.index.operations.embed_text.strategies.mock import (
                run as run_mock,
            )
