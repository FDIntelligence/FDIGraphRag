...
from fdigraphrag.config.models.chunking_config import ChunkingConfig, ChunkStrategyType
from fdigraphrag.index.operations.chunk_text.typing import (
    ChunkInput,
    ChunkStrategy,
)
...
def load_strategy(strategy: ChunkStrategyType) -> ChunkStrategy:
    ...
    match strategy:
        case ChunkStrategyType.tokens:
            from fdigraphrag.index.operations.chunk_text.strategies import run_tokens

            return run_tokens
        case ChunkStrategyType.sentence:
            # NLTK
            from fdigraphrag.index.operations.chunk_text.bootstrap import bootstrap
            from fdigraphrag.index.operations.chunk_text.strategies import run_sentences
