...
from fdigraphrag.index.operations.embed_graph.typing import NodeEmbeddings
from fdigraphrag.index.operations.layout_graph.typing import (
    GraphLayout,
    NodePosition,
)
...
def compute_umap_positions(
    ...
    # NOTE: This import is done here to reduce the initial import time of the fdigraphrag package
    import umap
