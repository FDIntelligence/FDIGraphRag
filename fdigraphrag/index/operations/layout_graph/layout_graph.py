...
from fdigraphrag.index.operations.layout_graph.typing import GraphLayout
...
def _run_layout(
    ...
    if enabled:
        from fdigraphrag.index.operations.layout_graph.umap import (
            run as run_umap,
        )
    ...
    from fdigraphrag.index.operations.layout_graph.zero import (
        run as run_zero,
    )
