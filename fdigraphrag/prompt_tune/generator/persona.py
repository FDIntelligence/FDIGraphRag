...
"""Persona generating module for fine-tuning fdigraphrag prompts."""

from fdigraphrag.language_model.protocol.base import ChatModel
from fdigraphrag.prompt_tune.defaults import DEFAULT_TASK
from fdigraphrag.prompt_tune.prompt.persona import GENERATE_PERSONA_PROMPT


async def generate_persona(
    model: ChatModel, domain: str, task: str = DEFAULT_TASK
) -> str:
    """Generate an LLM persona to use for fdigraphrag prompts.
