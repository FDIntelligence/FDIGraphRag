...
"""Language detection for fdigraphrag prompts."""

from fdigraphrag.language_model.protocol.base import ChatModel
from fdigraphrag.prompt_tune.prompt.language import DETECT_LANGUAGE_PROMPT


async def detect_language(model: ChatModel, docs: str | list[str]) -> str:
    """Detect input language to use for fdigraphrag prompts.
