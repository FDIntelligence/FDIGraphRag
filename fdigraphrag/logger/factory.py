...
from fdigraphrag.logger.rich_progress import RichProgressLogger
    ...
    def create_logger(
        ...
        match logger_type:
            case LoggerType.RICH:
                return RichProgressLogger("fdigraphrag Indexer ")
            case LoggerType.PRINT:
                return PrintProgressLogger("fdigraphrag Indexer ")
